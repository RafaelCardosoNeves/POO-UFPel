...
public class Room 
{
     ...
     */
    public Item pegaItem(String nome){
...
// novos metodos trabalho
    //inserir item
     public Set<String> pegaConjuntoDeItem() {
    	return itens.keySet();
    }
       public void insertItem(Item item){
    	this.itens.put(item.pegaNome(), item);
    }
  //remove item 
       public void removeItem(Item item){
    	this.itens.remove(item.pegaNome(), item);
    }
  public void removePersonagem(Personagem personagem){
    	this.itens.remove(personagem.pegaNome(), personagem);
    }
    void insertItem(String comida) {
